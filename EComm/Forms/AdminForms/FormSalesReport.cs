    ...
    public partial class FormSalesReport : UserControl
    {
        ...
        private void FormSalesReport_Load(object sender, EventArgs e)
        {
            ...
            CartesianChartSales.AxisY.Add(new LiveCharts.Wpf.Axis{
                Title = "Sales",
                LabelFormatter = value => value.ToString() + "Rs"
            });
        }
        ...
        private void CartesianChartSales_ChildChanged(object sender, System.Windows.Forms.Integration.ChildChangedEventArgs e)
        {
